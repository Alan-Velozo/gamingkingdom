            ...
            async handleSubmit() {
                ...
                try {
                    ...
                    if (error.code === 'auth/invalid-email') {
                        ...
                        this.error = 'Ha ocurrido un error al registrarse.';
                    }
                }
                this.loading = false;
            }
            ...
            <div class="login-container">
                ...
                <div class="login-form">
                    ...
                    <form action="#" @submit.prevent="handleSubmit">
                        ...
                        <div class="login-ask">
                            <p>¿Ya tienes una cuenta? <router-link to="/iniciar-sesion">Inicia sesión</router-link></p>
                        </div>

                        <div class="submit">
                            <input type="submit" value="REGISTRARSE" :loading="loading">
                        </div>
...
<style scoped>
    ...
    .login-container .login-form form .username,
    .login-container .login-form form .password,
    .login-container .login-form form .submit{
        width: 100%;
    }

    .login-container .login-form form .username i,
    ...
    .login-container .login-form form .username input,
